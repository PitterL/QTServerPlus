...
class TextInput(FocusBehavior, Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self._label_cls = kwargs.pop('label_cls', Label)
        self._label_cached = None
        self._line_options = kwargs.pop('label_option', None)
    ...
    def _get_line_options(self):
        ...
        if self._line_options is None:
            self._line_options = kw = {
                ...
                'padding_y': 0,
                'padding': (0, 0)}
            self._label_cached = self._label_cls(**kw)
    ...
    def _create_line_label(self, text, hint=False):
        ...
        if texture is None:
            ...
            while True:
                try:
                    label = self._label_cls(text=ntext[:label_len], **kw)
                    label.refresh()
